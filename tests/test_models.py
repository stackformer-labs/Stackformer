...
def test_small_model_forward_and_generation() -> None:
    ...
    gpt1 = GPT_1(vocab_size=vocab_size, num_layers=1, embed_dim=16, num_heads=4, seq_len=seq_len, dropout=0.0, hidden_dim=32)
    gpt2 = GPT_2(vocab_size=vocab_size, num_layers=1, embed_dim=16, num_heads=4, seq_len=seq_len, dropout=0.0, hidden_dim=32)
    l1 = llama_1(vocab_size=vocab_size, num_layers=1, embed_dim=16, num_heads=4, seq_len=seq_len, dropout=0.0, hidden_dim=32)
    g12 = gemma_1_2b(vocab_size=vocab_size, num_layers=1, embed_dim=16, num_heads=4, seq_len=seq_len, dropout=0.0, hidden_dim=32)
